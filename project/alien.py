...
class Alien(Sprite):
    ...
    def __init__(self,ai_game):
        ...
        new_width = int(alien_image.get_width() * ai_game.settings.alien_scaling)
        new_height = int(alien_image.get_height()/alien_image.get_width() * new_width)
        self.image = pygame.transform.smoothscale(alien_image, (new_width, new_height)) 
